...
class GenerateModel():
    ...
    def generate_motion(self, model, trainer_args, dm):
        dataloader = dm.predict_dataloader_shuffle()
        model.eval()
        ...
        for data in dataloader:
            ...
            #shuffle the behav_speakerB
            indices = torch.randperm(behav_speakerB.size(0))
            behav_speakerB = behav_speakerB[indices]
            print("Shuffled behav_speakerB", len(behav_speakerB))
